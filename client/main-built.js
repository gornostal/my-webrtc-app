...
define('text!templates/home.html',[],function () { return '<div class="home">\n    <div class="container">\n\n      <form class="form-signin" action="" onsubmit="javascript:return false;">\n        <h2 class="form-signin-heading">Enter a Room ID</h2>\n        <input title="You can use letters, numbers and _ -" type="text" class="input-block-level" autofocus placeholder="Room ID">\n        <button class="btn btn-large btn-primary" type="submit">Create/Join Room</button>\n      </form>\n\n    </div>\n</div>';});

define('views/home',['backbone', 'jquery', 'text!templates/home.html'], function (Backbone, $, homeTpl) {
...
define('text!templates/room.html',[],function () { return '<div class="app-container">\n\n    <div class="masthead">\n        <h3 class="muted room">Room: <b style="color: black"><%= room %></b></h3>\n        <span class="alert" id="user-left">User left the room!</span>\n    </div>\n\n    <hr>\n\n    <div class="content clearfix">\n            <div class="chat-ctl">\n                <form action="" method="POST" id="chat-form">\n                    <div id="chat-log" class="chat-log">\n                    </div>\n                    <input type="text" id="chat-msg" placeholder="write something nice">\n                    <button type="submit" class="btn btn-primary disabled btn-small send-msg">Send</button>\n                </form>\n            </div>\n\n        <div class="views">\n            <div id="remote-view"></div>\n            <div id="local-view"></div>\n            <div class="status">Status: <i id="status-msg">Loading...</i></div>\n            <button type="button" class="btn btn-danger hangup">Hang Up</button>\n        </div>\n\n    </div>\n\n\n</div>';});

define('module/socket',['io'], function(io){
...
define('module/room',['module/socket'], function(socket){
...
define('module/adapter',[],function(){
...
define('module/chat',['jquery'], function($){
    return function(){
        var $msg = $('#chat-msg'),
            $log = $('#chat-log'),
            isActive = false;
...
define('module/dataChannel',['underscore'], function(_){
    /**
     * returns dataChannel
     */
...
define('module/setStatus',[],function(){
    return function(msg){
...
define('module/establishConnection',[
  'module/socket',
  'module/adapter',
  'module/chat',
  'module/dataChannel',
...
define('module/router',['backbone', 'views/home', 'views/room'], function(Backbone, HomeView, RoomView){
...
define('text!templates/not-supported.html',[],function () { return '<div class="container-narrow">\n\n    <div class="masthead">\n        <h3 class="muted">Sorry, your browser doesn\'t support getUserMedia API</h3>\n    </div>\n\n    <hr>\n\n    <div id="content">\n        <iframe src="http://caniuse.com/stream/embed/"></iframe>\n    </div>\n\n\n</div>';});
